    ...
    public void testAddNewEmployee() {
        ...
        try {
            ...
            WebElement addButton = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//a[contains(., 'Thêm Nhân Viên')]")));
            addButton.click();
            System.out.println("✔ Đã mở form thêm nhân viên");
