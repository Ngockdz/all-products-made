    ...
    public void testRemoveFromCart() {
        ...
        try {
         ...
         // --- ĐĂNG NHẬP ---
            ...
            // --- XÓA SẢN PHẨM ---
            WebElement removeButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".btn-danger")));
            removeButton.click();
            ...
            assertTrue("Giỏ hàng không trống sau khi xóa", emptyMessage.isDisplayed());
